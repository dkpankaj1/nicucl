                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="fs-14 mb-1">Wallet</div>
                                </div>

                                <div class="d-flex align-items-baseline mb-2">
                                    <div class="fs-22 mb-0 me-2 fw-semibold text-black"> ₹ {{auth()->user()->wallet}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <a href="#">
                                        <div class="border rounded-3 px-2 py-3 text-center">
                                            ...
                                            <p class="text-muted mb-0 fs-13">
                                                <span class="text-success bg-success-subtle rounded-2 p-1 me-2"><i
                                                        class="mdi mdi-arrow-up-circle"></i> 2.5%</span>
                                            </p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-6 col-xl-3">
                                    <a href="#">
                                        <div class="border rounded-3 px-2 py-3 text-center">
                                            ...
                                            <p class="text-muted mb-0 fs-13">
                                                <span class="text-success bg-success-subtle rounded-2 p-1 me-2"><i
                                                        class="mdi mdi-arrow-up-circle"></i> 1.6%</span>
                                            </p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-6 col-xl-3">
                                    <a href="#">
                                        <div class="border rounded-3 px-2 py-3 text-center">
                                            ...
                                            <p class="text-muted mb-0 fs-13">
                                                <span class="text-danger bg-danger-subtle rounded-2 p-1 me-2"><i
                                                        class="mdi mdi-arrow-down-circle"></i> 7.7%</span>
                                            </p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-6 col-xl-3">
                                    <a href="#">
                                        <div class="border rounded-3 px-2 py-3 text-center">
                                            ...
                                            <p class="text-muted mb-0 fs-13">
                                                <span class="text-success bg-success-subtle rounded-2 p-1 me-2"><i
                                                        class="mdi mdi-arrow-up-circle"></i> 17.6%</span>
                                            </p>
                                        </div>
                                    </a>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a
                                    class="btn text-black border fw-normal d-flex align-items-center justify-content-center text-capitalize rounded-3 mt-3">View
                                    reports snapshot <i class="mdi mdi-arrow-right ms-2 fs-17"></i></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="d-flex align-items-center">
                                            <div
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="53.9" height="16"
                                                    viewBox="0 0 256 114">
                                                    <path fill="#1a1f71"
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center">
                                            <div
                                                class="avatar-md me-3 align-items-center justify-content-center d-flex">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="30.88" height="16"
                                                    viewBox="0 0 256 199">
                                                    <path
                        ...
                        <div class="row">
                            <div class="col-md-4 col-xl-4">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span
                                            class="avatar-xs rounded-circle bg-success-subtle d-flex justify-content-center align-items-center me-2"><i
                                                class="mdi mdi-arrow-up fs-13 text-success"></i></span>
                            ...
                            <div class="col-md-4 col-xl-4">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span
                                            class="avatar-xs rounded-circle bg-danger-subtle d-flex justify-content-center align-items-center me-2"><i
                                                class="mdi mdi-arrow-down fs-13 text-danger"></i></span>
                                        <p class="text-muted mb-0 fs-13">+ $ 1,670.76</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-group custom-group">
                            ...
                            <li
                                class="list-group-item align-items-center d-flex justify-content-between border-bottom">
                                <div class="product-list">
                                    <img class="avatar-md p-1 rounded-circle bg-primary-subtle img-fluid me-3"
                        ...
                        <div class="table-responsive">
                            <table class="table table-traffic mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-reset">Create user interface
                                            designs.</a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-reset">Test new features and
                                            updates.</a>
                                    </td>
                                    <td class="text-nowrap text-reset">
                                        <i data-feather="calendar" style="height: 18px; width: 18px;"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-reset">Conduct user feedback
                                            surveys</a>
                                    </td>
                                    <td class="text-nowrap text-reset">
                                        <i data-feather="calendar" style="height: 18px; width: 18px;"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-reset">Review codebase for security
                                            vulnerabilities</a>
                                    </td>
                                    <td class="text-nowrap text-reset">
                                        <i data-feather="calendar" style="height: 18px; width: 18px;"
